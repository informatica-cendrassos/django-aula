...
ACCES_RESTRINGIT_A_GRUPS = (
    None  # exemple per restringir = ['direcció','administradors','psicopedagog']
)
...
ADMINS = (("dani Herrera", "ctrl.alt.d@gmail.com"),)
...
GSUITE_CREDENTIALS_FILE = os.path.join(
    PROJECT_DIR, r"../customising/djau-compte-servei-sample.json"
)
