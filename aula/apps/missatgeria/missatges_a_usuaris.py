...
ALUMNE_GENERAR_CARTA = "S'ha de generar carta per acumulació de faltes de l'alumne {0}."
...
ERROR_REALITZANT_PAGAMENT_ONLINE_MOBIL = (
    "Pagament realitzat amb el mòbil no s'ha pogut emmagatzemar a la Base de dades"
)
